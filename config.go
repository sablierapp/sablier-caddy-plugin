...
type Config struct {
	SablierURL      string                 `json:"sablierURL,omitempty"`
	Names           []string               `json:"names,omitempty"`
	Group           string                 `json:"group,omitempty"`
	SessionDuration *time.Duration         `json:"session_duration,omitempty"`
	Dynamic         *DynamicConfiguration  `json:"dynamic,omitempty"`
	Blocking        *BlockingConfiguration `json:"blocking,omitempty"`
}
